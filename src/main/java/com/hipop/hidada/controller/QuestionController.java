...
import com.hipop.hidada.model.dto.question.*;
...
public class QuestionController {
    ...
    private static final String GENERATE_QUESTION_SYSTEM_MESSAGE = "你是一位严谨的出题专家，我会给你如下信息：\n" +
            ...
            "```\n" +
            "[{\"options\":[{\"value\":\"选项内容\",\"key\":\"A\",\"result\":\"I\",\"score\":\"0\"},{\"value\":\"\",\"key\":\"B\",\"result\":\"E\",\"score\":\"0\"}],\"title\":\"题目标题\"}]\n" +
            "```\n" +
            "title 是题目，options 是选项，每个选项的 key 按照英文字母序（比如 A、B、C、D）以此类推，value 是选项内容，result 是选项属性（测评类应用才有），score 是选项值（得分类应用才有，一道题目的最高分为10分）\n" +
